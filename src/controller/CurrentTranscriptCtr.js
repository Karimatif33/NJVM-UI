...
exports.fetshingCurrentTranscript = AsyncHandler(async (req, res) => {
  ...
  const apiUrl = `https://oerp.horus.edu.eg/WSNJ/HUECurrentTranscript?index=StudentCurrentTranscript&student_id=${StuId}&curr_academic_year=${selectedacadyearvalue}&curr_semester=${selectedsemestervalue}`;
